...
public class ORCompilationStrategy extends BasicCompilationStrategy {
    public String handle(nNode node) {

        String curvar1 = "";
        String curvar2 = "";
        String true1 = BasicCompilationStrategy.getNextLabel("true");
        ...
        code += "IF " + curvar1 + "=1" + " THEN GOTO " + true1 + "\n";
        code += "IF " + curvar2 + "=1" + " THEN GOTO " + true1 + "\n";
        code += "LET " + resVar + "=0\n";
        code += "GOTO " + end + "\n";
        code += "REM " + true1 + "\n";
        code += "LET " + resVar + "=1\n";
